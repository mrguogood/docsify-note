...
- elk
  ...
  - 运行（部署）方式：使用docker-compose管理部署elk的
    ...
    - 具体如何部署
      ...
      - 简单描述docker-compose.yml的配置![img](https://api2.mubu.com/v3/document_image/28641981_ba67f112-95e4-4215-aaaa-9219b6665479.png?)

      - Logstash 配置 logstash.conf 示例（监听 Docker 日志）：![img](https://api2.mubu.com/v3/document_image/28641981_3b8e2fef-4dc5-4f30-8074-75453fe4631f.png?)
...
- <img src="./../images/28641981_b40157c8-ddc6-421a-ebd5-89d42ae11cba-1769503717855-10.png" alt="img" style="zoom: 67%;" />

- <img src="./../images/28641981_4103d130-928f-4a0f-8d9d-f9d552a13f75-1769505920116-12.png" alt="img" style="zoom: 50%;" />

- <img src="./../images/28641981_3ef219d2-4bde-4acc-f2d1-961951bef2d1-1769506096570-14.png" alt="img" style="zoom: 50%;" />
